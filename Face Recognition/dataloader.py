...
# Group pictures are neglected in this function, as it is not possible to find which face belongs to the person of our interest. This is done only for training purpose.
