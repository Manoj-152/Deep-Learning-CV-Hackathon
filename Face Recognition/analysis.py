...
def face_extractor(list):
    ...
    for pics in list:
        ...
        faces = face_cascade.detectMultiScale(image,scaleFactor=1.25,minNeighbors=5,minSize=(30, 30)) # Please tune the scale-factor parameter to detect the face (needed sometimes)
        cnt += 1
